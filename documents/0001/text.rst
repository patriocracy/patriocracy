...
**Постмодерн** -- гносеологическая парадигма, в которой любое знание имеет значение (например, истинно, ложно, неопределённо) только в определённом контексте. В роли контекста могут выступать умозрительные модели, претендующие на более или менее полное описание наблюдаемых объектов и систем.
